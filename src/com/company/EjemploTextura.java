...
public class EjemploTextura extends Application {
    ...
    private Box TexturaBox(){
        //Para escoger un color de caja
        //PhongMaterial textura = new PhongMaterial(Color.BROWN);

        //Para escoger una imagen
        PhongMaterial textura = new PhongMaterial();
        textura.setDiffuseMap(new Image(getClass().getResourceAsStream("/assets/madera.png")));
